...
class TestDownloadRequestSubmitter(BaseTransferRequestSubmitterTest):
    ...
    def test_submit_with_no_overwrite_flag_when_file_exists_at_destination(self):
        # Setting up the CLI params with no_overwrite flag as True
        self.cli_params['no_overwrite'] = True
        fileinfo = self.create_file_info(self.key)
        # Mocking os.path.exists to return True, to simulate that file already exists
    ...
    def test_submit_with_no_overwrite_flag_when_file_does_not_exist_at_destination(self):
        # Setting up the CLI params with no_overwrite flag as True
        self.cli_params['no_overwrite'] = True
        fileinfo = self.create_file_info(self.key)
