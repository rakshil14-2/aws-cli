...
class BucketVersionLister:
    ...
    def list_object_versions(self, bucket, prefix=None, page_size=None, extra_args=None):
        """
        ...
        for page in pages:
            ...
            for version in versions:
                ...
                version['LastModified'] = self._date_parser(version['LastModified'])
            ...
            for delete_marker in delete_markers:
                source_path = bucket + "/" + delete_marker['Key']
                delete_marker['LastModified'] = self._date_parser(delete_marker['LastModified'])
                delete_marker['DeleteMarker'] = True
                yield source_path, delete_marker, delete_marker['VersionId']
